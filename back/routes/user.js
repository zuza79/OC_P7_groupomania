...
router.get('/profile/:id', auth, userCtrl.getOneUser);  //ok postman sans auth  localhost:3000/api/auth/profile/2
...
router.get('/', auth, userCtrl.getAllUsers); // ok postman sans auth localhost:3000/api/auth
